...
import { View, Text, StyleSheet ,Dimensions,ScrollView, StatusBar,Image,FlatList} from 'react-native';
 ...
 const askPermission = async()=>{
  ...
  const getLocation = async()=>{
      try{
          ...
          } = await RNLocation.getCurrentLocation();
            ...
            <ScrollView bounces={false}>
              ...
              <Text style={styles.text1}>Destress your commute</Text>
               <View style={styles.view1}>
                 <View style={styles.view8}>
                   <Text style={styles.text2}>Read a book.Take a snap.Store out the window</Text>
              ...
              <View style={styles.view5}>
               <View style={styles.view6}>
                 ...
                 <View>
                 <Text style={{fontSize:18,color:colors.black}}>32 near rajaji nagar</Text>
                 <Text style={{color:colors.grey3}}>2nd rajaji nagar phase2</Text>
                 </View>
                </View>
               <View>
               <Icon type="material-community"
